...
PAIRS="intro-countersnipe countersnipe-prediction prediction-ventures ventures-contact"
...
generate_connector() {
  ...
  higgsfield generate create seedance_2_0_mini \
    ...
    --resolution 720p --aspect_ratio 16:9 --duration 5 --generate-audio=false \
