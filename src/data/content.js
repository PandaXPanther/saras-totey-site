...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-19T09:51:20.352Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+60.3%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "126", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "52", foot: "Across the three-repo fleet" },
  ],
};
