...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-07T10:54:30.195Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+68.6%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "114", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "40", foot: "Across the three-repo fleet" },
  ],
};
