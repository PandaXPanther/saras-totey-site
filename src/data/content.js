...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-12T09:42:40.667Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+47.1%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "119", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "45", foot: "Across the three-repo fleet" },
  ],
};
