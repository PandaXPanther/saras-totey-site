...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-09T10:16:23.720Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+67.6%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "116", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "42", foot: "Across the three-repo fleet" },
  ],
};
