...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-26T10:25:53.143Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+33.9%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "133", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "59", foot: "Across the three-repo fleet" },
  ],
};
