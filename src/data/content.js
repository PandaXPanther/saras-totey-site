...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-13T10:43:51.267Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+44.2%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "120", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "46", foot: "Across the three-repo fleet" },
  ],
};
