...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-10T10:10:10.842Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+56.4%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "117", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "43", foot: "Across the three-repo fleet" },
  ],
};
