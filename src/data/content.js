...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-30T10:50:27.851Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+51.7%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "106", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "32", foot: "Across the three-repo fleet" },
  ],
};
