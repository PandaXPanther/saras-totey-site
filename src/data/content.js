...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-24T10:39:49.320Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+41.1%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "131", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "57", foot: "Across the three-repo fleet" },
  ],
};
