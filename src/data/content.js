...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-31T12:00:17.278Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+52.0%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "107", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "33", foot: "Across the three-repo fleet" },
  ],
};
