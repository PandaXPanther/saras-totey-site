...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-06T09:49:01.978Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+60.1%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "113", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "39", foot: "Across the three-repo fleet" },
  ],
};
