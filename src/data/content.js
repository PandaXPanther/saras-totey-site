...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-16T10:24:20.950Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+50.3%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "123", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "49", foot: "Across the three-repo fleet" },
  ],
};
