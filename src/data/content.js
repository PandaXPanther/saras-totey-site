...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-25T10:43:09.870Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+41.8%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "132", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "58", foot: "Across the three-repo fleet" },
  ],
};
