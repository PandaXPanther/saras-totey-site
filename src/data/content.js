...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-23T10:23:24.449Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+36.9%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "130", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "56", foot: "Across the three-repo fleet" },
  ],
};
