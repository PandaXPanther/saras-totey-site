...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-21T11:17:14.103Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+44.1%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "128", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "54", foot: "Across the three-repo fleet" },
  ],
};
