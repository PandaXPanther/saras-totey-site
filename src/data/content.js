...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-22T10:28:12.906Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+39.8%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "129", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "55", foot: "Across the three-repo fleet" },
  ],
};
