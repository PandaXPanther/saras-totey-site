...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-24T06:33:04.786Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+32.0%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "100", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "26", foot: "Across the three-repo fleet" },
  ],
};
