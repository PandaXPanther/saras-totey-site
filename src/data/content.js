...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-03T10:15:31.071Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+52.3%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "110", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "36", foot: "Across the three-repo fleet" },
  ],
};
