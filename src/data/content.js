...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-08T10:12:32.599Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+58.6%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "115", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "41", foot: "Across the three-repo fleet" },
  ],
};
