...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-18T10:10:11.793Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+69.1%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "125", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "51", foot: "Across the three-repo fleet" },
  ],
};
