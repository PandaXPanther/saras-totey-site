...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-17T10:33:57.991Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+49.5%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "124", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "50", foot: "Across the three-repo fleet" },
  ],
};
