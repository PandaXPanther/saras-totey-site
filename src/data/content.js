...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-29T11:52:52.692Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+47.2%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "105", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "31", foot: "Across the three-repo fleet" },
  ],
};
