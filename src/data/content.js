...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-26T06:26:17.133Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+46.7%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "102", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "28", foot: "Across the three-repo fleet" },
  ],
};
