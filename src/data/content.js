...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-04T10:04:49.661Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+61.3%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "111", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "37", foot: "Across the three-repo fleet" },
  ],
};
