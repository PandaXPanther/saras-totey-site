...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-25T06:23:49.536Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+32.5%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "101", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "27", foot: "Across the three-repo fleet" },
  ],
};
