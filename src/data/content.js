...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-28T17:48:31.531Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+48.7%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "104", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "30", foot: "Across the three-repo fleet" },
  ],
};
