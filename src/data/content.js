...
export const LIVE = {
  ...
  last_updated_iso: '2026-08-27T16:59:07.839Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+41.0%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "103", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "29", foot: "Across the three-repo fleet" },
  ],
};
