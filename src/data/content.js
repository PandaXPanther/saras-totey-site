...
export const LIVE = {
  ...
  last_updated_iso: '2026-09-15T10:35:53.720Z',
  cards: [
    ...
    { k: "Hyperliquid cohort · top-5 30d ROI", v: "+49.4%", foot: "Recomputed from seed_wallets.json + Hyperliquid leaderboard API" },
    { k: "Days since CounterSnipe live", v: "122", foot: "Since May 16, 2026" },
    { k: "Days since last commit", v: "48", foot: "Across the three-repo fleet" },
  ],
};
